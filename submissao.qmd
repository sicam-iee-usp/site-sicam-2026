...
<center><a href="/submissoes-aprovadas.qmd" ><button type="button" class="btn btn-info">Confira as submissões aprovadas </button></center></a>
...
| Data | Descrição |
|------------------------|------------------------------------------------|
| 24/07/2026 | Abertura das submissões de trabalhos |
| 21/09/2026 | Prazo final para submissão de trabalhos |
| 16/10/2026 | Data prevista para divulgação dos resultados dos trabalhos submetidos |
| 23/10/2026 | Data limite para inscrição de autores que apresentarão os trabalhos aprovados |
| 28/10/2026 | Data limite para inscrição de participantes ouvintes |

## Sobre a submissão

As pessoas interessadas em participar do evento terão a opção de submeter seus trabalhos em forma de **apresentação oral**, distribuídos em [**Grupos Temáticos (GTs)**](grupos-tematicos.qmd).

<center><a href="/grupos-tematicos.qmd" ><button type="button" class="btn btn-info">Confira os Grupos Temáticos </button></center></a>
...
Para facilitar a formatação dos trabalhos pelos autores, a Comissão Organizadora do 6º SICAM também disponibilizou um template para a submissão:

<center><a href="https://github.com/sicam-iee-usp/site-sicam-2026/raw/main/template_submissao.docx" target="_blank"><button type="button" class="btn btn-info">Clique aqui para acessar <br> o template de submissão</button></center>
...
<center><a href="https://forms.gle/zaMigRcPrdnrvyNC7" target="_blank"><button type="button" class="btn btn-info">Acesse o formulário de <br> submissão! </button></center>
